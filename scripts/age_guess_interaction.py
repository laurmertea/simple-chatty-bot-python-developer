...
# The `numbersremainder3`, `remainder5` and `remainder7` 
# are the remainders of division by 3, 5 and 7 respectively.

# It turns out that for each number ranging from 0 to 104 
# the calculation will result in the number itself. 
